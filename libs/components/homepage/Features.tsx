	...
	return (
		...
		>
			...
			<Container sx={{ maxWidth: '1300px', mx: 'auto' }}>
				<Box className="wow fadeInUp" sx={{ textAlign: 'center', mb: 6 }}>
					<Typography component="h2" sx={{ fontWeight: 700, fontSize: '2.2rem' }}>
						Why Choose Us?
					</Typography>
				</Box>
				...
				<Grid container spacing={3}>
					...
					<Grid item xs={12} sm={6} md={3}>
						...
						>
							...
							<Typography fontSize="1.2rem" fontWeight={600} sx={{ mb: 1 }}>
